        ...
        <div>
          ...
          <div className="flex justify-center">
            ...
            <div className="flex items-center gap-5 mt-5 text-xs justify-between text-gray-500">
              <p className="hover:text-lime-700 transition-all duration-700 cursor-pointer font-semibold">Home</p>
              <p><i className="fa-solid fa-chevron-right"></i></p>
              <p className="hover:text-lime-700 transition-all duration-700 cursor-pointer font-semibold" >SHOP</p>
